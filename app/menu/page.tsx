  ...
  return (
    <>
      <div className="relative">
        <Nav />
        <div className="pt-28 pb-8 px-10" style={{ background: "#1a0a04" }}>
          <div className="max-w-4xl mx-auto">
            <p className="eyebrow text-[var(--red)] mb-3">What We Serve</p>
              ...
              <ul className="grid grid-cols-2 gap-x-12 gap-y-5">
                {category.items.map(item => (
                  <li key={item.name} className="flex items-start justify-between gap-4">
                    ...
                    <span className="font-sans text-[var(--brown)] text-sm shrink-0 mt-0.5">
